...
// Ambil kegiatan RAFTING (bisa berdasarkan jenis_kegiatan atau divisi tertentu)
// Asumsi: kegiatan RAFTING bisa difilter berdasarkan nama kegiatan yang mengandung 'gunung' atau 'climbing' atau divisi RAFTING
                    ...
                    <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                        <div class="hero-slide" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('<?= $bg_image ?>'); background-size: cover; background-position: center; min-height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; padding: 2rem 1rem;">
                            <div class="hero-content">
                                <h1 class="hero-title">RAFTING</h1>
                                <p class="hero-subtitle">Mari mengarungi sungai bersama kami!!</p>
            ...
            <?php else: ?>
                <div class="carousel-item active">
                    <div class="hero-slide" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('assets/img/default-mountain.jpg'); background-size: cover; background-position: center; min-height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; padding: 2rem 1rem;">
                        <div class="hero-content">
                            <h1 class="hero-title">RAFTING</h1>
                            <p class="hero-subtitle">Kegiatan pengarungan sungai yang melatih teknik mendayung, kerja sama tim, serta keselamatan dalam arung jeram.</p>
                            <div class="hero-kegiatan-info">
                                <p class="kegiatan-coming-soon">
                                    <i class="fas fa-mountain"></i> 
                                    Kegiatan Rafting akan segera hadir!
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="content-card" style="background: white; padding: 2rem; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <h2 style="color: #333; font-size: 1.8rem; font-weight: bold; margin-bottom: 1.5rem;">APA SIH RAFTING DI EDELWEIS ?</h2>
                    ...
                    <p style="color: #666; line-height: 1.8; font-size: 1rem; text-align: justify;">
                        Rafting di UKM-PA Edelweis adalah kegiatan pengarungan sungai yang melatih teknik dasar hingga lanjutan dalam olahraga arung jeram. Kami menekankan pada kerja sama tim, keterampilan navigasi air, dan keamanan di setiap pengarungan.
                    </p>
                    <p style="color: #666; line-height: 1.8; font-size: 1rem; text-align: justify; margin-top: 1.5rem;">
                       Melalui pelatihan mendayung, manuver perahu, hingga ekspedisi sungai, anggota akan memperoleh pengalaman seru sekaligus pemahaman mendalam tentang keselamatan dan konservasi ekosistem sungai.
                    </p>
            ...
            <div class="col-lg-4">
                <div class="sidebar-card" style="background: #f8f9fa; padding: 2rem; border-radius: 10px; height: 100%;">
                    ...
                    <?php else: ?>
                        <p style="color: #666; font-size: 0.9rem; line-height: 1.6;">
                            Belum ada kegiatan RAFTING yang tersedia. Pantau terus untuk update kegiatan terbaru!
                        </p>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="feature-card" style="background: white; padding: 2rem; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <h3 style="color: #333; margin-bottom: 1.5rem;">Kegiatan Rafting/Arung Jeram</h3>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="activity-item" style="text-align: center;">
                                ...
                                <h5 style="color: #333;">Pengarungan Sungai</h5>
                                <p style="color: #666; font-size: 0.9rem;">belajar mendayung, manuver, dan navigasi sungai.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="activity-item" style="text-align: center;">
                                ...
                                <h5 style="color: #333;">Kerja Sama Tim</h5>
                                <p style="color: #666; font-size: 0.9rem;">membangun koordinasi dan komunikasi dalam tim perahu.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="activity-item" style="text-align: center;">
                                ...
                                <h5 style="color: #333;">Keselamatan Sungai</h5>
                                <p style="color: #666; font-size: 0.9rem;">pemahaman SOP keselamatan dan rescue di air.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                                        ...
                                        <div class="card-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.3); display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;">
                                            <div class="card-content" style="text-align: center; color: white; opacity: 0; transform: translateY(20px); transition: all 0.3s ease;">
                                                ...
                                                <p style="font-size: 0.9rem; margin-bottom: 1rem;">
                                                    ...
                                                    <?php else: ?>
                                                        Kegiatan RAFTING yang mengajarkan teknik pendakian dan survival skills.
                                                    <?php endif; ?>
                                                </p>
                ...
                <?php else: ?>
                    <div style="text-align: center; color: white; padding: 3rem;">
                        ...
                        <p>Galeri kegiatan RAFTING akan muncul di sini setelah ada kegiatan yang terlaksana.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="modal-content" style="background: white; max-width: 800px; width: 90%; border-radius: 10px; position: relative; margin: 2rem auto;">
                ...
                <div class="row" style="margin: 0;">
                    <div class="col-lg-6" style="padding: 2rem;">
                        ...
                        <?php else: ?>
                            <p style="color: #666; line-height: 1.8; text-align: justify;">
                                Kegiatan <?= htmlspecialchars($kegiatan['nm_kegiatan']) ?> merupakan bagian dari program RAFTING 
